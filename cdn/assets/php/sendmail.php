...
|
*/
$reciever        = "hola@telecoastur.com";
$default_subject = "Solicitud de información Web";

$sender_email    = "no-reply@telecoastur.com";
$sender_name     = "TelecoAstur";
$error_message   = "Error de envío";
